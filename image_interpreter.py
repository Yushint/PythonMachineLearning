...
import cv2
import numpy as np
from machine_learning import build_model

def interpriateImage(image_path):
    model = build_model()
    result = rec_digit(image_path, model=model)
    return result
...
if __name__ == "__main__":
    result = interpriateImage("./current_image.jpg")
